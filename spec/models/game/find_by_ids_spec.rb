...
describe Game, :find_by_ids do
  it "returns the found games ordered by name" do
    game1 = Factory.create(:game, {:name => 'c', :id => Id.new})
    game2 = Factory.create(:game, {:name => 'd', :id => Id.new})
    game3 = Factory.create(:game, {:name => 'a', :id => Id.new})
    game3 = Factory.create(:game, {:name => 'b', :id => Id.new})
