...
describe Leaderboard, :score_is_better? do
  ...
  it "returns true for a lower daily score for special daily track latest mode" do
    leaderboard = Factory.build(:leaderboard, {:type => LeaderboardType::HighToLow, :mode => LeaderboardMode::DailyTracksLatest})
    ...
    leaderboard = Factory.build(:leaderboard, {:type => LeaderboardType::LowToHigh, :mode => LeaderboardMode::DailyTracksLatest})
