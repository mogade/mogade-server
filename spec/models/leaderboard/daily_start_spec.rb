...
describe Leaderboard, :daily_start do
  ...
  it "returns the time adjusted for a negative offset which has rolled over to today" do
    ...
    Factory.build(:leaderboard, {:offset => -3}).daily_start.should == Time.utc(2010, 8, 10, 3)
  end
  ...
  it "returns the time adjusted for a negative offset which hasn't rolled over to today" do
    ...
    Factory.build(:leaderboard, {:offset => -5}).daily_start.should == Time.utc(2010, 8, 9, 5)
  end
  ...
  it "returns the time adjusted for a postive offset which hasn't rolled over to today" do
    ...
    Factory.build(:leaderboard, {:offset => 3}).daily_start.should == Time.utc(2010, 8, 9, 21)
  end
  ...
  it "returns the time adjusted for a postive offset which has rolled over to today" do
    ...
    Factory.build(:leaderboard, {:offset => 5}).daily_start.should == Time.utc(2010, 8, 9, 19)
  end
